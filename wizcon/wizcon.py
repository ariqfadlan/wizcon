...
def parse_args(args):
    parser = argparse.ArgumentParser(description='Control Philips WiZ Connected Turnable White smart bulb',
    ...
    parser.add_argument('-si', '--scene_id', type=int, choices=[6, *range(9,17), 18, *range(29,33)], metavar='6 | {9,16} | 18 | {29-32}', help='Set scene of smart bulb using scene ID')
